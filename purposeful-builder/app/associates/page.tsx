...
export default function AssociatesPage() {
  return (
    <main className="min-h-screen pt-32 px-5 max-w-4xl mx-auto" style={{ background: "var(--parchment)", color: "var(--ink)" }}>
      ...
      <h1 className="font-serif text-5xl md:text-6xl mb-8 leading-tight">Condit <span className="text-[#cba37c]">Associates Ltd</span></h1>
      <p className="text-lg opacity-80 leading-relaxed max-w-2xl border-l-2 border-[#c4572a] pl-6">
        This page is currently being built. It will serve as the digital home for Condit Associates Ltd, highlighting our work in construction, architecture, and project management.
      </p>
    </main>
  );
}
