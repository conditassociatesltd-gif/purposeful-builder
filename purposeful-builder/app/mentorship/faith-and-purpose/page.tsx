    ...
    <main className="min-h-screen pt-32 pb-24 px-5" style={{ background: "var(--parchment)", color: "var(--ink)" }}>
      <div className="max-w-2xl mx-auto">
        ...
        <article className="essay-content prose">
          ...
          <p>
            What steadied me was not finding a better identity. It was realising that my identity had already been settled by God and that all my searching was just me running from the answer that was already there.
          </p>
          <p>
