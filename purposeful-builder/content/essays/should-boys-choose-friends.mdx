...
<div className="p-8 mb-16 mt-8 border-l-4" style={{ backgroundColor: "color-mix(in srgb, var(--rust) 10%, transparent)", borderColor: "var(--rust)" }}>
...
<p className="text-lg md:text-xl leading-relaxed mb-6 font-serif opacity-80">
  <span className="float-left text-7xl font-serif leading-none pr-3 pt-2" style={{ color: "var(--rust)" }}>T</span>he environment a boy grows up in will largely determine the kind of friends he keeps. And the friends he keeps will largely determine the man he becomes.
</p>
